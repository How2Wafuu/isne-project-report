...
\section{\ifenglish Project rationale\else ที่มาของโครงงาน\fi}
    District-level healthcare facilities face a critical cybersecurity crisis, as they are frequent targets holding sensitive data but lack the financial resources and specialized expertise to defend themselves effectively. Therefore, this project is essential because it will implement a fully configured, open-source Security Information and Event Management (SIEM) and XDR framework using Wazuh. This approach directly addresses how able Wazuh is to the compliance such as HAIT+, a crucial standard for hospitals to follow. Along with the deployment guidance of configurations within wazuh to meet the requirements.
