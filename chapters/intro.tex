...
\section{\ifenglish Project rationale\else ที่มาของโครงงาน\fi}
    District‑level healthcare facilities are facing a critical cybersecurity challenge. They are frequent targets of cyberattacks and are responsible for storing highly sensitive data, yet they typically lack both the financial resources and the specialized expertise required to implement robust security controls. This project addresses that gap by designing and deploying a fully configured, open‑source Security Information and Event Management (SIEM) and Extended Detection and Response (XDR) framework based on Wazuh. The proposed solution aims to evaluate the extent to which Wazuh can support compliance with healthcare security standards such as HAIT+, and to provide detailed deployment guidance and configuration recommendations within Wazuh to meet those requirements.
...
\begin{itemize}
    ...
    \item {Asset management: To enable comprehensive visibility and monitoring of all IT assets within the hospital's network, including servers, workstations, network devices, and medical equipment, ensuring they are properly secured and compliant with security policies.}
...
\begin{plan}{6}{2025}{3}{2026}
    ...
    \planitem{8}{2025}{10}{2025}{System Design}
    \planitem{9}{2025}{2}{2026}{Prototype Implementation}
    \planitem{3}{2026}{3}{2026}{Presentation}
    \planitem{2}{2026}{3}{2026}{Final Report Documentation}
\end{plan}
...
\textbf{Software} & Overleaf Student Plan Subscription for collaborative authoring & 2 months & 290.00 & 580.00 \\ \addlinespace
